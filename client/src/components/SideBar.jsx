...
const SideBar = ({ sidebar, setSidebar }) => {
  ...
  return (
    <div
      className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between items-center max-sm:absolute relative z-50 top-0 bottom-0 ${
    ...
    >
      <div className="my-3 w-full">
        ...
        <div className="px-5 mt-2 text-sm text-gray-600 font-medium">
